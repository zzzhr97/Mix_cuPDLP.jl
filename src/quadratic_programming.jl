...
function print_variable_and_constraint_hardness(
	...
	# * hardness为constraint_matrix的行范数与对偶变量绝对值的乘积
	...
	Printf.@printf(
		...
		quantile(variable_hardness, 0.99),	# 分位数
